                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="job-detail.html" class="dropdown-item active">Post A Job</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <div class="dropdown-menu rounded-0 m-0">
...
if ($customer_result->num_rows > 0) {
    ...
    while ($customer_row = $customer_result->fetch_assoc()) {
        ...
        echo '              <span class="mb-4"><i class="fa fa-info text-primary me-2"></i>' . $customer_row["description"] . '</span>';
        echo' <br><br> ';
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom" href="https://htmlcodex.com">kawinda</a>
                        </div>
